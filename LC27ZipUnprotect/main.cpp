/*
   Source Code by David Honisch
   Big thanx to Justme for Original C++ Cracking Code
*/
#include "variables.h"
bool directorytest()
{
...
system("cls");
cout << "7zUnprotect by	David Honisch V0.01	12/2011 \n";
cout << "Based on Justme Source Code 1/2010 \n";
ss.str("");
...
cout << "7zUnprotect by	David Honisch V0.01	12/2011 \n";
cout << "Based on Justme Source Code 1/2010 \n";
cout << "Enter Filename(Example: test.7z):";
ss.str("");
cin >> paths;
